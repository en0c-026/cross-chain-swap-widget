...
interface LoaderObject {
   ...
   */
  q: Array<[MethodNames, AppConfigurations]>;
}
    ...
    switch (methodName) {
      case 'init':
        ...
        if (loadedObject.targetId) {
          ...
          console.log('Error: Undefined targeId. Please pass a targeId property, with the id value of the element that will contain the widget.')
        }
